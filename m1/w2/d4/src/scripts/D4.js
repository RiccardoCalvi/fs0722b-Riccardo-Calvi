...
function es10() {
  ...
  console.log(`Il personaggio di Star Wars si chiama: ${element.name} è alto ${element.height}cm e pesa ${element.mass}kg è un ${element.gender}. È nato nel ${element.birth_year} ed i suoi capelli sono ${element.hair_color} ed i suoi occhi sono ${element.eye_color}.`)
}
